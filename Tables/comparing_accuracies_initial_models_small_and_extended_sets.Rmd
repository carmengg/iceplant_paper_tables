...
initial <- read_csv('accuracy_comparisons_initial_test_set.csv')
extended <- read.csv('accuracy_comparisons_extended_test_set.csv')
...
```{r}
accuracies_table(initial, 'model','aaaaa')
```
