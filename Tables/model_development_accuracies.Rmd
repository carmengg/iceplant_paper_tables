...
accs <- read_csv('accuracies_feature_experiments.csv')
accs
```
...
spectral_df$Features <- c('spectral','spectral, date', 'spectral, NDVI', 'spectral, date, NDVI')
...
subtitle =  "Accuracies and classification results into iceplant (positive class) an other vegetation (negative class) from models with different combinations of spectral, date and NDVI features."
